package br.com.cmo.service;

import br.com.assmbl.domain.dto.mapper.EnderecoMapper;
import br.com.assmbl.domain.dto.mapper.MenbroMapper;
import br.com.assmbl.domain.dto.mapper.ObreiroMapper;
...
import br.com.assmbl.domain.repository.EnderecoRepository;
import br.com.assmbl.domain.repository.HistoricoObreiroRespository;
import br.com.assmbl.domain.repository.MenbroRespository;
import br.com.assmbl.domain.repository.ObreiroReposistory;
...
public class ObreiroService {
	...
	public MessageResponseDTO cadastra(ObreiroDTO obreiroDTO) throws MenbroNotFoundException {
		...
		Menbro menbro = menbroRepository.findByName(nomeMenbro).orElseThrow(() -> new MenbroNotFoundException(nomeMenbro));
	...
	public MessageResponseDTO atualizar(ObreiroDTO obreiroDTO) throws ObreiroNotFoundException {
		String nomeMenbro = obreiroDTO.getMenbroDTO().getPessoa().getNome();
		Menbro menbro = menbroRepository.findById(obreiroDTO.getId())
